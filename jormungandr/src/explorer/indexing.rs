                ...
                let metx = match fragment {
                    ...
                    Fragment::OwnerStakeDelegation(tx) => {
                        ...
                        Some(ExplorerTransaction::from(
                            ...
                            prev_transactions,
                            prev_blocks,
                            Some(Certificate::OwnerStakeDelegation(tx.payload().into_owned())),
                        ))
                    }
                    Fragment::StakeDelegation(tx) => {
                        ...
                        Some(ExplorerTransaction::from(
                            ...
                            prev_transactions,
                            prev_blocks,
                            Some(Certificate::StakeDelegation(tx.payload().into_owned())),
                        ))
                    }
                    Fragment::PoolRegistration(tx) => {
                        ...
                        Some(ExplorerTransaction::from(
                            ...
                            prev_transactions,
                            prev_blocks,
                            Some(Certificate::PoolRegistration(tx.payload().into_owned())),
                        ))
                    }
                    Fragment::PoolRetirement(tx) => {
                        ...
                        Some(ExplorerTransaction::from(
                            ...
                            prev_transactions,
                            prev_blocks,
                            Some(Certificate::PoolRetirement(tx.payload().into_owned())),
                        ))
                    }
                    Fragment::PoolUpdate(tx) => {
                        ...
                        Some(ExplorerTransaction::from(
                            ...
                            prev_transactions,
                            prev_blocks,
                            Some(Certificate::PoolUpdate(tx.payload().into_owned())),
                        ))
                    }
                    _ => None,
                };
